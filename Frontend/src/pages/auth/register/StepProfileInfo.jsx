...
const StepProfileInfo = ({onContinue}) => {
    ...
    return (
        <div className='bg-white max-md:mx-4 p-4 rounded-2xl space-y-2 lg:w-[520px] sm:w-[450px] w-full py-6 px-4.5' >
            ...
            <div className='border border-gray-200 py-2 px-4 rounded-md flex md:flex-row flex-col  items-center  justify-between mt-6'>
                <div className='flex md:flex-row flex-col gap-2.5 items-center'>
                    ...
                    <div className='max-md:text-center'>
                        ...
                        <p className='text-gray-600  text-[12px]'>400 <span>x</span> 400 px, max file size 10 MB</p>
                    </div>
                </div>
            ...
            <div className='space-y-3 mt-5'>
                ...
                <div className='border hover:bg-gray-50 border-gray-200 p-[8px] rounded-md flex items-center justify-between pr-3 mt-1 '>
                    <input
