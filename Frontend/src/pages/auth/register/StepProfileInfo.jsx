...
const StepProfileInfo = ({onContinue}) => {
    ...
    return (
        <div className='bg-white p-4 rounded-2xl space-y-2 lg:w-[550px] sm:w-[450px] py-6 px-4.5' >
            ...
            <p className='text-gray-600  text-[14px]'>Enter your personal data/information, from name until phone <br /> number, make sure everything is filled in completely.</p>

            <div className='border border-gray-200 py-2.5 px-4 rounded-md flex items-center  justify-between mt-6'>
