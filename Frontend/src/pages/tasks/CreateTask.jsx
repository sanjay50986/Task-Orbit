    ...
    return (
        ...
        `}>
                ...
                <div className='my-6 px-5 '>
                    ...
                    <div className='grid grid-cols-[140px_1fr] gap-y-7 mt-6 text-[#4B4F5C] font-medium'>
                    ...
                    <div className='flex my-12 justify-end gap-3'>
                        <button onClick={closeCreateTask} className='cursor-pointer border border-gray-200 p-2 rounded-lg text-[14px] hover:bg-gray-100 duration-200 font-medium px-4'>Cancel</button>
                        <button className='cursor-pointer border border-gray-200 p-2 bg-[#212529] rounded-lg text-[14px] text-white hover:bg-[#6C757D]  duration-200 font-medium px-4'>Create Task</button>
                    </div>
                </div>
            </div>
        </>
